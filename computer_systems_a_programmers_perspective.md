...
| Type      | Storage (Bytes) | Signed or Unsigned | Storage (Bits)                          | Number of Combinations Available                                | Minimum Value | Maximum Value |
| --------- | --------------- | ------------------ | --------------------------------------- | --------------------------------------------------------------- | ------------- | ------------- |
| TINYINT   | 1               | Signed             | `(Storage (Bytes) * 8)` == `1 * 8 = 8 ` | `(2 ^ Storage (Bits))` == `2 ^ 8  = 256`                        | -128          | 127           |
| TINYINT   | 1               | Unsigned           | `(Storage (Bytes) * 8)` == `1 * 8 = 8 ` | `(2 ^ Storage (Bits))` == `2 ^ 8  = 256`                        | 0             | 255           |
| SMALLINT  | 2               | Signed             | `(Storage (Bytes) * 8)` == `2 * 8 = 16` | `(2 ^ Storage (Bits))` == `2 ^ 16 = 65,536`                     | -32768        | 32767         |
| SMALLINT  | 2               | Unsigned           | `(Storage (Bytes) * 8)` == `2 * 8 = 16` | `(2 ^ Storage (Bits))` == `2 ^ 16 = 65,536`                     | 0             | 65535         |
| MEDIUMINT | 3               | Signed             | `(Storage (Bytes) * 8)` == `3 * 8 = 24` | `(2 ^ Storage (Bits))` == `2 ^ 24 = 16,777,216`                 | -8388608      | 8388607       |
| MEDIUMINT | 3               | Unsigned           | `(Storage (Bytes) * 8)` == `3 * 8 = 24` | `(2 ^ Storage (Bits))` == `2 ^ 24 = 16,777,216`                 | 0             | 16777215      |
| INT       | 4               | Signed             | `(Storage (Bytes) * 8)` == `4 * 8 = 32` | `(2 ^ Storage (Bits))` == `2 ^ 32 = 4,294,967,296`              | -2147483648   | 2147483647    |
| INT       | 4               | Unsigned           | `(Storage (Bytes) * 8)` == `4 * 8 = 32` | `(2 ^ Storage (Bits))` == `2 ^ 32 = 4,294,967,296`              | 0             | 4294967295    |
| BIGINT    | 8               | Signed             | `(Storage (Bytes) * 8)` == `8 * 8 = 64` | `(2 ^ Storage (Bits))` == `2 ^ 64 = 18,446,744,073,709,551,616` | -2^( 63 )     | 2^( 63 )-1    |
| BIGINT    | 8               | Unsigned           | `(Storage (Bytes) * 8)` == `8 * 8 = 64` | `(2 ^ Storage (Bits))` == `2 ^ 64 = 18,446,744,073,709,551,616` | 0             | 2^( 64 )-1    |
